...
Cloner https://github.com/Zomzog/2025-iut-td.git
...
Créer une implémentation de Database nommée `ListDatabase`,
...
Dans la classe de test Exercice#exo1_1, charger le contexte Spring à partir de AppConfig
...
Dans la classe de test Exercice#exo1_2, charger le contexte Spring à partir de AppConfig
...
Dans la classe de test Exercice#exo1_3, charger le contexte Spring à partir de AppConfig
pour obtenir une instance des services.
...
Créer une classe de tests unitaires ListDatabaseTest qui couvre à 100% ListDatabase.
...
Ajouter les dépendances de test `io.mockk:mockk-jvm:1.14.6` et `com.ninja-squad:springmockk:4.0.2`.
